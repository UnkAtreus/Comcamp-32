        ...
        <div>
            <nav >
                        <div id="nav" className="Nav-Row">
                            ...
                            <a data-scroll href="#intro" id="nav-home" className="Nav-Links nav-right Nav-Back">
                            <i aria-label="icon: left" className="anticon anticon-left ant-select-arrow-icon">
                                ...
                                <div className="Nav-Links Nav-Name"><span>{user.displayName}</span></div>

                                <div className="Nav-Links Nav-Logout"><span>Logout</span></div>
