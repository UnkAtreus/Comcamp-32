...
const locations = ['มา มจธ. ด้วยตนเอง', 'สถานีขนส่งผู้โดยสารกรุงเทพฯ (สายใต้ใหม่)', 'สถานีขนส่งผู้โดยสารกรุงเทพฯ (เอกมัย)', 'สถานีรถไฟกรุงเทพ (สถานีหัวลำโพง)', 'อนุเสาวรีย์ชัยสมรถภูมิ']
